...
export const mockPDCAItems: PDCAItem[] = [
  {
    ...
    plannedActions: 'Implementar herramientas de testing automatizado y definir nuevos procesos de QA',
    actualResults: 'Implementación de nuevas herramientas de testing automatizado en progreso',
    lessons: 'La automatización requiere mayor tiempo de configuración inicial',
    nextSteps: 'Finalizar configuración y capacitar al equipo',
  ...
  },
  {
    ...
    plannedActions: 'Crear plantillas estándar y procedimientos de documentación',
    actualResults: 'En fase de planificación, definiendo requerimientos',
    lessons: 'Pendiente de ejecución',
    nextSteps: 'Iniciar diseño de plantillas',
  ...
  },
  {
    ...
    plannedActions: 'Diseñar encuestas de satisfacción y implementar sistema de seguimiento',
    actualResults: 'Índice de satisfacción del 92%, identificadas 3 áreas de mejora',
    lessons: 'Las encuestas cortas tienen mejor tasa de respuesta',
    nextSteps: 'Implementar plan de acción para áreas identificadas',
